...
'Attention: Failed to save forum order',
'forums_ajax_reorder_fail_desc' => 
'We failed to save your new forum order. Refresh the page and make sure you\'re logged in.',
'recipients' => 
'recipients',
'create_forum_alias' => 
'Create Forum Alias',
...
'Enable board',
'enable_board_desc' => 
'When set to <b>enable</b>, this forum board will be accessible to member groups with proper permissions.',
'name' => 
'Name',
'name_desc' => 
...
'When set to <b>enable</b>, clickable thumbnails will be shown in posts.',
'thumbnail_width' => 
'Thumbnail width',
...
'When set to <b>yes</b>, the date and time a post was edited will be shown in the post.',
'notification_settings' => 
'Notification Settings',
'topic_notifications' => 
'Topic notifications',
'topic_notifications_desc' => 
'When set to <b>enable</b>, all recipients listed will receive e-mail notification when a <b>new</b> topic is posted.</em><em>Separate multiple e-mails with a <mark>comma (,)</mark>.',
'reply_notification' => 
'Reply notification',
'reply_notification_desc' => 
'When set to <b>enable</b>, all recipients listed will receive e-mail notification when a <b>new</b> reply is made.</em><em>Separate multiple e-mails with a <mark>comma (,)</mark>.',
...
'autolink_urls_desc' => 
'When set to <b>yes</b>, <abbr title=\"Unified Resource Locator\">URL</abbr>s and e-mail address will be rendered as links in this forum\'s posts.',
'allow_image_hotlinking' => 
'Allow image hot-linking?',
'allow_image_hotlinking_desc' => 
'When set to <b>yes</b>, users will be allowed to hot-link an image in a forum post.',
'rss_settings' => 
'<abbr title=\"Really Simple Syndication\">RSS</abbr> Settings',
'enable_rss' => 
'Enable <abbr title=\"Really Simple Syndication\">RSS</abbr>?',
'enable_rss_desc' => 
'When set to <b>enable</b>, <abbr title=\"Really Simple Syndication\">RSS</abbr> will be available for forums.',
...
'When set to <b>enable</b>, users will need to enter authentication to access <abbr title=\"Really Simple Syndication\">RSS</abbr> for forums.',
'permissions_warning' => 
...
'When set to <b>enable</b>, these permissions will be the default permissions for all created forums.',
'view_forums' => 
'View forums',
'view_forums_desc' => 
