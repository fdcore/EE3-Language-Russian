...
'results for the search term <mark>%s</mark>',
'search_for' => 
'Search for \"%s\"',
'channel_manager' => 
'Channel Manager',
...
'You have reached the maximum number of Channels allowed.',
'import' => 
'Import',
'export_set' => 
'Export Channel Set',
...
'Cannot Export Channel Set',
'channel_set_not_exported_desc' => 
'Not a valid channel.',
'channel_set_upload_error' => 
'Cannot Import Channel',
'channel_set_upload_error_desc' => 
'We were unable to import the channel, please make sure your cache folder is writable.',
'channel_set_duplicates_error' => 
'Import Creates Duplicates',
'channel_set_duplicates_error_desc' => 
'This channel set uses names that already exist on your site. Please rename the following items.',
'channel_set_imported' => 
'Channel Imported',
'channel_set_imported_desc' => 
'The channel was successfully imported.',
'edit' => 
'edit',
'settings' => 
'settings',
...
'<b>%s</b> contains at least one required field and cannot be hidden. Please move the required field(s) to another tab.',
'error_cannot_remove_tab' => 
'Cannot Remove Tab',
'error_tab_has_fields' => 
'<b>%s</b> contains at least one field and cannot be removed. Please move all fields to another tab.',
'assigned_to' => 
'assigned to',
'edit_channel' => 
'Edit Channel',
...
'<b>Warning</b>: Channels require custom field groups to collect any data other than title, and date.',
'channel_publishing_options_warning2' => 
'If you need to collect additional data for this channel, it\'s best practice to create any <a href=\"%s\">custom field groups</a>, first.',
'default_status_group' => 
'Default Statuses',
'status_groups_not_found' => 
'No <b>status groups</b> found',
'create_new_status_group' => 
'Create New Status Group',
'custom_field_group' => 
'Custom field group',
'custom_field_groups_not_found' => 
'No <b>custom field groups</b> found',
'create_new_field_group' => 
'Create New Field Group',
'custom_fields_desc' => 
'Choose the fields you would like to include in this field group.',
'category_groups_not_found' => 
'No <b>category groups</b> found',
'create_new_category_group' => 
'Create New Category Group',
'channel_created' => 
'Channel Created',
'channel_created_desc' => 
'The channel <b>%s</b> has been created.',
'channel_not_created' => 
'Cannot Create Channel',
'channel_not_created_desc' => 
'We were unable to create this channel, please review and fix errors below.',
'channel_updated' => 
'Channel Updated',
'channel_updated_desc' => 
'The channel <b>%s</b> has been updated.',
'channel_not_updated' => 
'Cannot Update Channel',
'channel_not_updated_desc' => 
'We were unable to update this channel, please review and fix errors below.',
'invalid_short_name' => 
...
'Status',
'default_status_desc' => 
'Status assigned to all <b>new</b> entries in this channel.',
'default_category' => 
'Category',
...
'When set to <b>yes</b>, a second set of publish controls will appear at the top of the publish form for this channel.',
'convert_image_urls' => 
...
'Allow comments?',
'allow_comments_desc' => 
'When set to <b>yes</b>, members can submit comments to this channel\'s entries.',
'allow_comments_checked' => 
'Allow comments default?',
'allow_comments_checked_desc' => 
'When set to <b>yes</b>, the \"Allow comments\" option will be set to \"yes\" by default',
'require_membership' => 
'Require membership?',
'require_membership_desc' => 
'When set to <b>yes</b>, only registered members can submit comments to this channel\'s entries.',
'require_email' => 
'Require Email?',
'require_email_desc' => 
...
'channel_settings_saved_desc' => 
'The settings for channel <b>%s</b> have been saved.',
'channel_settings_not_saved' => 
'Cannot Save Channel Settings',
'channel_settings_not_saved_desc' => 
'We were unable to save this channel\'s settings, please review and fix errors below.',
'categories' => 
'Categories',
'category' => 
'Category',
...
'No <b>member groups</b> with permissions found',
'edit_member_groups' => 
'Edit Member Groups',
'exclude_group_form' => 
'Exclude group from?',
...
'The category group <b>%s</b> has been updated.',
'category_group_not_updated' => 
'Cannot Update Category Group',
'category_group_not_updated_desc' => 
'We were unable to update this category group, please review and fix errors below.',
'cat_image_none' => 
...
'status_group_created_desc' => 
'The status group <b>%s</b> has been created.',
'status_group_not_created' => 
'Cannot Create Status Group',
'status_group_not_created_desc' => 
'We were unable to create this status group, please review and fix errors below.',
'status_group_updated' => 
'Status Group Updated',
'status_group_updated_desc' => 
'The status group <b>%s</b> has been updated.',
'status_group_not_updated' => 
'Cannot Update Status Group',
'status_group_not_updated_desc' => 
'We were unable to update this status group, please review and fix errors below.',
'status_name' => 
'Status Name',
'statuses' => 
'Statuses',
...
'Status Created',
'status_created_desc' => 
'The status <b>%s</b> has been created.',
'status_not_created' => 
'Cannot Create Status',
'status_not_created_desc' => 
'We were unable to create this status, please review and fix errors below.',
'status_updated' => 
'Status Updated',
'status_updated_desc' => 
'The status <b>%s</b> has been updated.',
'status_not_updated' => 
'Cannot Update Status',
'status_not_updated_desc' => 
'We were unable to update this status, please review and fix errors below.',
