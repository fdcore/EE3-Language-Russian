...
'Register New',
'members_desc' => 
'Members are registered users of your site. You <em>must</em> have at least one member, an administrator.',
'new_members_permission_desc' => 
'You may <a href=\"%s\">change the settings</a> to allow or disallow, new member registrations.',
'banned_members' => 
'Banned Members',
'content' => 
'Content',
'content_desc' => 
'Channel entries, why folks visit.',
'entries_with_comments' => 
'<b>%d</b> Entries with %d comments',
'closed_entries_with_comments' => 
'<b>%d</b> Closed entries with %d comments.',
'' => 
'',
''=>'');